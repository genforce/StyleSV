...
hydra.run.dir=. \
exp_suffix=ytb256_stylesv_finetune \
...
model.generator.learnable_motion_mask=true model.generator.init_motion_mask=zeros model.generator.fuse_w=concat \
model.discriminator.tsm=true \
model.discriminator.tmean=true \
model.loss_kwargs.r1_gamma=8 \
num_gpus=8 training.snap=100 \
training.aug=noaug \
training.resume=${YOURPATH}/videogen/work_dirs/ytb256_stylesv_pretrain_05_bgc/output/best_fid.pkl \
project_release_dir=${YOURPATH}/videogen/work_dirs/ytb256_stylesv_finetune_noaug_256