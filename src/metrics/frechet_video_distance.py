...
NUM_FRAMES_IN_BATCH = {128: 128, 256: 128, 512: 128, 1024: 32}

#----------------------------------------------------------------------------

def compute_fvd(opts, max_real: int, num_gen: int, num_frames: int, subsample_factor: int=1, cache_suffix: str=''):
    ...
    mu_real, sigma_real = metric_utils.compute_feature_stats_for_dataset(
        ...
        capture_mean_cov=True, max_items=max_real, temporal_detector=True, batch_size=batch_size, cache_suffix=cache_suffix).get_mean_cov()
